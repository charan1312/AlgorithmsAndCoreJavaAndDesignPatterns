...
public class CourseAndTAAsgnmnt2b {
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		C[0] = new Course();
		C[0].setCid(0);
		C[0].TAPrefofCforA2.add(1);C[0].TAPrefofCforA2.add(2);C[0].TAPrefofCforA2.add(3);C[0].TAPrefofCforA2.add(4);C[0].TAPrefofCforA2.add(5);
		Clist.add(C[0].getCid());

		C[1] = new Course();
		C[1].setCid(1);
		C[1].TAPrefofCforA2.add(5);C[1].TAPrefofCforA2.add(3);C[1].TAPrefofCforA2.add(2);C[1].TAPrefofCforA2.add(1);C[1].TAPrefofCforA2.add(4);
		Clist.add(C[1].getCid());

		C[2] = new Course();
		C[2].setCid(2);
		C[2].TAPrefofCforA2.add(1);C[2].TAPrefofCforA2.add(5);C[2].TAPrefofCforA2.add(4);C[2].TAPrefofCforA2.add(3);C[2].TAPrefofCforA2.add(2);
		Clist.add(C[2].getCid());

		C[3] = new Course();
		C[3].setCid(3);
		C[3].TAPrefofCforA2.add(1);C[3].TAPrefofCforA2.add(2);C[3].TAPrefofCforA2.add(3);C[3].TAPrefofCforA2.add(4);C[3].TAPrefofCforA2.add(5);
		Clist.add(C[3].getCid());

		C[4] = new Course();
		C[4].setCid(4);
		//WRONG PREFERENCE VALUES
		C[4].TAPrefofCforA2.add(2);C[4].TAPrefofCforA2.add(5);C[4].TAPrefofCforA2.add(1);C[4].TAPrefofCforA2.add(3);C[4].TAPrefofCforA2.add(4);
		//CORRECT PREFERENCE VALUES
//		C[4].TAPrefofCforA2.add(5);C[4].TAPrefofCforA2.add(1);C[4].TAPrefofCforA2.add(4);C[4].TAPrefofCforA2.add(3);C[4].TAPrefofCforA2.add(2);
		...
		ta[0].setTAId(0);
		ta[0].CPrefofTA.add(4);ta[0].CPrefofTA.add(5);ta[0].CPrefofTA.add(2);ta[0].CPrefofTA.add(1);ta[0].CPrefofTA.add(3);

		ta[1] = new TA();
		ta[1].setTAId(1);
		ta[1].CPrefofTA.add(3);ta[1].CPrefofTA.add(3);ta[1].CPrefofTA.add(5);ta[1].CPrefofTA.add(4);ta[1].CPrefofTA.add(1);

		ta[2] = new TA();
		ta[2].setTAId(2);
		ta[2].CPrefofTA.add(2);ta[2].CPrefofTA.add(1);ta[2].CPrefofTA.add(5);ta[2].CPrefofTA.add(3);ta[2].CPrefofTA.add(4);

		ta[3] = new TA();
		ta[3].setTAId(3);
		ta[3].CPrefofTA.add(1);ta[3].CPrefofTA.add(3);ta[3].CPrefofTA.add(4);ta[3].CPrefofTA.add(5);ta[3].CPrefofTA.add(2);

		ta[4] = new TA();
		ta[4].setTAId(4);
		ta[4].CPrefofTA.add(1);ta[4].CPrefofTA.add(2);ta[4].CPrefofTA.add(5);ta[4].CPrefofTA.add(4);ta[4].CPrefofTA.add(3);
		...
		C[X].TAPrefofCforA2.add(5);C[X].TAPrefofCforA2.add(1);C[X].TAPrefofCforA2.add(4);C[X].TAPrefofCforA2.add(3);C[X].TAPrefofCforA2.add(2);
