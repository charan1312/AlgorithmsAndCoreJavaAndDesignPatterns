...
public class CourseAndTAAsgnmnt2a {
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		C[0] = new Course();
		C[0].setCid(0);
		C[0].TAPrefofCforA2.add(1);C[0].TAPrefofCforA2.add(2);C[0].TAPrefofCforA2.add(5);C[0].TAPrefofCforA2.add(4);C[0].TAPrefofCforA2.add(3);
		Clist.add(C[0].getCid());

		C[1] = new Course();
		C[1].setCid(1);
		C[1].TAPrefofCforA2.add(2);C[1].TAPrefofCforA2.add(1);C[1].TAPrefofCforA2.add(4);C[1].TAPrefofCforA2.add(3);C[1].TAPrefofCforA2.add(5);
		Clist.add(C[1].getCid());

		C[2] = new Course();
		C[2].setCid(2);
		C[2].TAPrefofCforA2.add(3);C[2].TAPrefofCforA2.add(4);C[2].TAPrefofCforA2.add(1);C[2].TAPrefofCforA2.add(2);C[2].TAPrefofCforA2.add(5);
		Clist.add(C[2].getCid());

		C[3] = new Course();
		C[3].setCid(3);
		//WRONG PREFERENCE VALUES
		C[3].TAPrefofCforA2.add(4);C[3].TAPrefofCforA2.add(5);C[3].TAPrefofCforA2.add(3);C[3].TAPrefofCforA2.add(2);C[3].TAPrefofCforA2.add(1);
		//CORRECT PREFERENCE VALUES
//		C[3].TAPrefofCforA2.add(3);C[1].TAPrefofCforA2.add(1);C[3].TAPrefofCforA2.add(2);C[3].TAPrefofCforA2.add(4);C[3].TAPrefofCforA2.add(5);
		Clist.add(C[3].getCid());

		C[4] = new Course();
		C[4].setCid(4);
		C[4].TAPrefofCforA2.add(5);C[4].TAPrefofCforA2.add(1);C[4].TAPrefofCforA2.add(2);C[4].TAPrefofCforA2.add(4);C[4].TAPrefofCforA2.add(3);
		...
		C[X].TAPrefofCforA2.add(3);C[X].TAPrefofCforA2.add(1);C[X].TAPrefofCforA2.add(2);C[X].TAPrefofCforA2.add(4);C[X].TAPrefofCforA2.add(5);
